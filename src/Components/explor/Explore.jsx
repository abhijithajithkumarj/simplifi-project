  ...
  return (
    ...
    >
      <div className="flex justify-center items-start p-4">
        <h1
          className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl text-white mt-14 uppercase"
      ...
      <div className="flex flex-col justify-center items-center mb-5">
        <div className="explore  flex flex-col justify-between ">
          ...
          <button
            ...
            type="button"
            className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800  sm:w-72 w-52 md:w-80 lg:w-96 mt-4"
          >
            Explore
          </button>
        </div>
